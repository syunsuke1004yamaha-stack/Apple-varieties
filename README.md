...
ハードオフで古いiPodを探しているときに似た見た目の製品があり混同してしまうことを不便に思い開発しました。iMacなどは同様のデザインのものが多いためCPUなどによる識別が役立つと考えています。また、デザインにはOS X Tiger風のAquaデザインを採用し、懐かしさを感じるデザインとしています。
